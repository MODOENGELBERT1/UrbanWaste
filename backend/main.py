...
async def generate_report(req: ReportRequest):
    """Rapport PDF 100% FR ou 100% EN — mise en page Banque Mondiale professionnelle."""
    ...
    _S = {
      "fr":{
        ...
        "cover_tagline":"Outil de planification géospatiale · Afrique subsaharienne",
        ...
        "col_metric":"Indicateur","col_before":"Avant","col_after":"Après","col_change":"Variation",
        "row_pop":"Population couverte (R1)","row_cov":"Taux de couverture (%)","row_out":"Hors service",
        "people":"personnes","pts":"pts","kg_day":"kg/jour",
        "lbl_strat":"Stratégie d'optimisation","lbl_conf":"Niveau de confiance","lbl_ready":"Maturité d'implémentation",
        "conf_high":"Élevée","conf_med":"Modérée","conf_low":"Faible",
        "col_id":"Bac","col_sc":"Score","col_md":"Mode",
        "col_pp":"Pop. R1","col_wt":"Déch. R1 (kg/j)","col_fq":"Fréq./sem",
        "col_rd":"Route (m)","col_ev":"Éc./Hôp./Eau (m)",
        "cls_a":"Classe A — Priorité haute","cls_b":"Classe B — Priorité moyenne","cls_c":"Classe C — Priorité basse",
        "class_a":"Classe A","class_b":"Classe B","class_c":"Classe C",
        "sc_balanced":"⚖  Équilibré","sc_walk_first":"🚶  Priorité marche","sc_access_first":"🚛  Priorité accès",
        "sc_bins":"Bacs","sc_cov":"Couverture","sc_pk":"Ramassages/sem",
        "row_well":"Bien desservi (R1)","row_und":"Mal desservi (anneaux ext.)","row_no":"Hors service","row_wno":"Déchets hors service",
        "top_ht":"Hotspot principal","truck":"Camion","tricycle":"Tricycle","foot":"À pied",
        "col_rsk":"Risque","col_mit":"Mitigation","drv_title":"Indicateur de confiance","drv_pct":"Score (%)",
        "mb":(
            "Les résultats sont fondés sur les données OpenStreetMap dont la complétude varie selon les zones. "
            "La population est estimée par proxy (bâtiments × PPH) et non par recensement officiel. "
            "Les emplacements proposés doivent être validés sur le terrain avant tout investissement. "
            "Le modèle ne tient pas compte des contraintes foncières, des autorisations municipales ni des dynamiques sociales locales."
        ),
        "disc":(
            "Ce rapport est un outil d'aide à la décision conforme aux standards ODD 11.6.1 (ONU-Habitat). "
            "Toute décision d'investissement doit être précédée d'une enquête terrain et d'une consultation communautaire."
        ),
        "footer":f"UrbanSanity v{VERSION} · Données OSM © OpenStreetMap contributors (ODbL) · World Bank What a Waste 2.0 (2018) · WACA Cameroun",
        ...
        "m_pts":"Points analysés","m_pop":"Population zone R1","m_waste":"Déchets zone R1","m_cov":"Couverture combinée (R1)",
        "m_vh":"Viabilité élevée","m_vm":"Viabilité modérée","m_vl":"Viabilité faible",
        "vib_h":"Élevée","vib_m":"Modérée","vib_l":"Faible",
        "m_note":(
            "Ces positions sont évaluées avec les mêmes paramètres MCDA que l'optimisation algorithmique "
            "(grille de demande, anneaux R1/R2/R3, contraintes de sécurité), sans être soumises au processus de sélection spatiale. "
            "Les résultats reflètent uniquement la suitabilité locale du site choisi."
        ),
      },
      "en":{
        "doc_title":"ANALYSIS REPORT",
        "cover_sub":"Urban Waste Collection Planning",
        "cover_tagline":"Geospatial planning tool · Sub-Saharan Africa",
        ...
        "col_metric":"Metric","col_before":"Before","col_after":"After","col_change":"Change",
        "row_pop":"Population covered (R1)","row_cov":"Coverage rate (%)","row_out":"Outside service",
        "people":"people","pts":"pts","kg_day":"kg/day",
        "lbl_strat":"Optimisation strategy","lbl_conf":"Confidence level","lbl_ready":"Implementation readiness",
        "conf_high":"High","conf_med":"Moderate","conf_low":"Low",
        "col_id":"Bin","col_sc":"Score","col_md":"Mode",
        "col_pp":"Pop. R1","col_wt":"Waste R1 (kg/d)","col_fq":"Freq./wk",
        "col_rd":"Road (m)","col_ev":"Sch./Hosp./Water (m)",
        "cls_a":"Class A — High priority","cls_b":"Class B — Medium priority","cls_c":"Class C — Lower priority",
        "class_a":"Class A","class_b":"Class B","class_c":"Class C",
        "sc_balanced":"⚖  Balanced","sc_walk_first":"🚶  Walk priority","sc_access_first":"🚛  Access priority",
        "sc_bins":"Bins","sc_cov":"Coverage","sc_pk":"Pickups/wk",
        "row_well":"Well served (R1)","row_und":"Underserved (outer rings)","row_no":"Outside service","row_wno":"Waste outside service",
        "top_ht":"Top hotspot","truck":"Truck","tricycle":"Tricycle","foot":"On foot",
        "col_rsk":"Risk","col_mit":"Mitigation","drv_title":"Confidence indicator","drv_pct":"Score (%)",
        "mb":(
            ...
            "The model does not account for land tenure constraints, municipal permits, or local social dynamics."
        ),
        "disc":(
            "This report is a decision-support tool aligned with SDG 11.6.1 (UN-Habitat). "
            "Any investment decision must be preceded by field validation and community consultation."
        ),
        "footer":f"UrbanSanity v{VERSION} · OSM data © OpenStreetMap contributors (ODbL) · World Bank What a Waste 2.0 (2018) · WACA",
        "m_banner":"⚠  Indicative results — manually placed points",
        "m_s1":"9.1 Collective summary","m_s2":"9.2 Point detail",
        "m_pts":"Points analysed","m_pop":"Population zone R1","m_waste":"Waste zone R1","m_cov":"Combined coverage (R1)",
        "m_vh":"High viability","m_vm":"Moderate viability","m_vl":"Low viability",
        "vib_h":"High","vib_m":"Moderate","vib_l":"Low",
        "m_note":(
            "These positions are evaluated with the same MCDA parameters as the algorithmic optimisation "
            "(demand grid, R1/R2/R3 rings, safety constraints), without being subject to the spatial selection process. "
            "Results reflect only the local suitability of the chosen site."
        ),
      }
    }
    ...
    CN=colors.HexColor("#002244"); CB=colors.HexColor("#00467F"); CS=colors.HexColor("#0082CA")
    CP=colors.HexColor("#E6F2FA"); CI=colors.HexColor("#F0F7FC"); CG=colors.HexColor("#D0DAE1")
    CGR=colors.HexColor("#1A7A4A"); CR=colors.HexColor("#C0392B"); CAM=colors.HexColor("#B87B00")

    def ps(nm,**kw): return ParagraphStyle(nm,parent=base["Normal"],**kw)
    H1 = ps("_h1",textColor=CB,fontSize=13,fontName="Helvetica-Bold",spaceBefore=12,spaceAfter=4)
    H2 = ps("_h2",textColor=CB,fontSize=11,fontName="Helvetica-Bold",spaceBefore=8,spaceAfter=3)
    ...
    KL = ps("_kl",fontSize=7.5,textColor=colors.HexColor("#5A6E84"),alignment=TA_CENTER,leading=9)
    FT = ps("_ft",fontSize=7.5,textColor=colors.HexColor("#5A6E84"),leading=10)
    now = datetime.now().strftime("%d/%m/%Y  %H:%M")
    story = []

    # ── Logo ──────────────────────────────────────────────────────────────────
    def make_logo(w=52,h=52):
        d=Drawing(w,h)
        d.add(Circle(26,26,24,strokeColor=CS,strokeWidth=1.8,fillColor=CP))
        d.add(Line(26,3,26,49,strokeColor=CS,strokeWidth=0.7))
        d.add(Line(3,26,49,26,strokeColor=CS,strokeWidth=0.7))
        d.add(Line(8,38,44,38,strokeColor=CS,strokeWidth=0.4))
        d.add(Line(8,14,44,14,strokeColor=CS,strokeWidth=0.4))
        d.add(Polygon([26,47,18,35,16,24,26,18,36,24,34,35],strokeColor=CGR,strokeWidth=1.2,fillColor=colors.HexColor("#27ae60")))
        d.add(Rect(21,22,10,13,strokeColor=CN,strokeWidth=1.3,fillColor=CN))
        d.add(Rect(19,34,14,3,strokeColor=CN,strokeWidth=1,fillColor=CS))
        d.add(Rect(23,37,6,2,strokeColor=CS,strokeWidth=0.8,fillColor=CS))
        d.add(Line(24,23,24,34,strokeColor=CP,strokeWidth=0.8))
        d.add(Line(26,23,26,34,strokeColor=CP,strokeWidth=0.8))
        d.add(Line(28,23,28,34,strokeColor=CP,strokeWidth=0.8))
        d.add(Circle(41,40,4.5,strokeColor=CR,strokeWidth=1.2,fillColor=colors.HexColor("#e74c3c")))
        d.add(Polygon([41,30,37,38,45,38],strokeColor=CR,strokeWidth=1,fillColor=colors.HexColor("#e74c3c")))
        return d

    logo=make_logo()
    inner=Table([
        [Paragraph("UrbanSanity",ps("_br",fontSize=24,fontName="Helvetica-Bold",textColor=colors.white,leading=28))],
        [Paragraph(L("cover_tagline"),ps("_tg",fontSize=9,textColor=colors.HexColor("#90b8d4"),leading=12))],
    ],colWidths=[14.5*cm])
    hdr=Table([[logo,inner]],colWidths=[1.7*cm,14.8*cm])
    hdr.setStyle(TableStyle([
        ("BACKGROUND",(0,0),(-1,-1),CN),("VALIGN",(0,0),(-1,-1),"MIDDLE"),
        ("TOPPADDING",(0,0),(-1,-1),14),("BOTTOMPADDING",(0,0),(-1,-1),14),
        ("LEFTPADDING",(0,0),(-1,-1),10),("RIGHTPADDING",(0,0),(-1,-1),8),
    ]))
    story+=[hdr,HRFlowable(width="100%",thickness=3,color=CS),Spacer(1,0.4*cm)]

    # Titre sans superposition — trois éléments séparés avec espacement explicite
    story.append(Paragraph(L("doc_title"),
        ps("_dt",fontSize=20,fontName="Helvetica-Bold",textColor=CB,alignment=TA_CENTER,spaceAfter=6)))
    story.append(Paragraph(L("cover_sub"),
        ps("_cs",fontSize=11.5,textColor=colors.HexColor("#5A6E84"),alignment=TA_CENTER,spaceAfter=14)))

    # Encadré zone + date
    zone_t=Table([
        [Paragraph(f"<b>{L('cover_zone')} :</b>  {city}",
                   ps("_zn",fontSize=11,textColor=CN,alignment=TA_CENTER,spaceAfter=0))],
        [Paragraph(f"{L('cover_date')} : {now}",
                   ps("_zd",fontSize=9,textColor=colors.HexColor("#5A6E84"),alignment=TA_CENTER,spaceAfter=0))],
    ],colWidths=[16.5*cm])
    zone_t.setStyle(TableStyle([
        ("BACKGROUND",(0,0),(-1,-1),CI),("BOX",(0,0),(-1,-1),1.5,CS),
        ("TOPPADDING",(0,0),(-1,-1),10),("BOTTOMPADDING",(0,0),(-1,-1),10),
    ]))
    story+=[zone_t,Spacer(1,0.4*cm)]

    # KPI
    kpi_t=Table([
        [Paragraph(f"{si(summary.get('n_buildings',0)):,}",KP),
         Paragraph(f"{si(summary.get('total_pop',0)):,}",KP),
         Paragraph(ff(summary.get('total_waste_kg_day',0),".0f"),KP),
         Paragraph(str(si(summary.get('n_proposed',len(proposed)))),KP)],
        [Paragraph(L("kpi_bldg"),KL),Paragraph(L("kpi_pop"),KL),
         Paragraph(L("kpi_waste"),KL),Paragraph(L("kpi_bins"),KL)],
    ],colWidths=[4.1*cm]*4)
    kpi_t.setStyle(TableStyle([
        ("BACKGROUND",(0,0),(-1,0),CP),("BACKGROUND",(0,1),(-1,1),CI),
        ("ALIGN",(0,0),(-1,-1),"CENTER"),("TOPPADDING",(0,0),(-1,-1),9),("BOTTOMPADDING",(0,0),(-1,-1),7),
        ("BOX",(0,0),(-1,-1),1.5,CB),("INNERGRID",(0,0),(-1,-1),0.4,colors.white),("LINEBELOW",(0,0),(-1,0),0.5,CS),
    ]))
    story+=[kpi_t,Spacer(1,0.4*cm)]

    # ── S1 Résumé Exécutif ───────────────────────────────────────────────────
    story.append(Paragraph(L("s1"),H1))
    conf_label=L("conf_high") if conf>=70 else (L("conf_med") if conf>=40 else L("conf_low"))
    read_score=si(readiness.get("score",0)); read_lbl=sp(readiness.get("label","—"))
    opt_strat=sp(summary.get("optimization_strategy","—")).replace("_"," ").title()
    et=Table([
        [L("lbl_strat"),opt_strat],
        [L("lbl_conf"),f"{conf}/100 — {conf_label}"],
        [L("lbl_ready"),f"{read_score}/100 — {read_lbl}"],
    ],colWidths=[5.5*cm,11*cm])
    et.setStyle(TableStyle([
        ("ROWBACKGROUNDS",(0,0),(-1,-1),[colors.white,CI]),("BACKGROUND",(0,0),(0,-1),CP),
        ("GRID",(0,0),(-1,-1),0.3,CG),("FONTSIZE",(0,0),(-1,-1),8.5),
        ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),7),
    ]))
    story.append(et)
    rec=sp(summary.get("recommendation",""))
    if rec and rec!="—":
        rt=Table([[Paragraph(f"★  {rec}",ps("_rc",fontSize=9.5,textColor=CN))]],colWidths=[16.5*cm])
        rt.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,-1),CP),("BOX",(0,0),(-1,-1),1.5,CS),
                                 ("LEFTPADDING",(0,0),(-1,-1),10),("TOPPADDING",(0,0),(-1,-1),9),("BOTTOMPADDING",(0,0),(-1,-1),9)]))
        story+=[Spacer(1,0.2*cm),rt]

    # BA table
    story+=[Spacer(1,0.3*cm),Paragraph(L("ba_title"),H2)]
    g_pct=sf(ba.get("gain_pct",0),1); sign="+" if g_pct>=0 else ""
    bat=Table(
        [[L("col_metric"),L("col_before"),L("col_after"),L("col_change")],
         [L("row_pop"),ff(ba.get("before_coverage_pop",0),".0f"),ff(ba.get("after_coverage_pop",0),".0f"),f"{sign}{g_pct:.1f} {L('pts')}"],
         [L("row_cov"),f"{ff(ba.get('before_coverage_pct',0),'.1f')} %",f"{ff(ba.get('after_coverage_pct',0),'.1f')} %",f"{sign}{g_pct:.1f} {L('pts')}"],
         [L("row_out"),"—",f"{ff(gaps.get('no_service_pct',0),'.1f')} %",f"{si(gaps.get('no_service_pop',0)):,} {L('people')}"]],
        colWidths=[5.5*cm,3*cm,3*cm,5*cm])
    bat.setStyle(TableStyle([
        ("BACKGROUND",(0,0),(-1,0),CB),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
        ("FONTSIZE",(0,0),(-1,-1),8.5),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
        ("GRID",(0,0),(-1,-1),0.3,CG),("ALIGN",(1,0),(-1,-1),"CENTER"),
        ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),6),
    ]))
    story.append(bat)

    # ── S2 Sites prioritaires ────────────────────────────────────────────────
    story+=[PageBreak(),Paragraph(L("s3"),H1)]
    MODE_LBL={"truck":L("truck"),"tricycle":L("tricycle"),"foot":L("foot")}
    CLASS_BG={"A":colors.HexColor("#D1FAE5"),"B":colors.HexColor("#FEF3C7"),"C":colors.HexColor("#DBEAFE")}
    rows_=[[L("col_id"),L("col_sc"),L("col_md"),L("col_pp"),L("col_wt"),L("col_fq"),L("col_rd"),L("col_ev")]]
    for idx,b in enumerate(proposed[:50],1):
        cls=sp(b.get("class","C"),"C"); mode=MODE_LBL.get(sp(b.get("collection_mode","—"),"—"),sp(b.get("collection_mode","—")))
        rows_.append([Paragraph(f"<b>#{idx}</b>  {cls}",SM),Paragraph(ff(b.get("score",0),".3f"),SM),Paragraph(mode,SM),
                      Paragraph(f"{si(b.get('population_r1',0)):,}",SM),Paragraph(ff(b.get("waste_r1_kg_day",0),".1f"),SM),
                      Paragraph(f"{sp(b.get('pickups_per_week','—'))}×",SM),Paragraph(f"{si(b.get('road_dist_m',0))} m",SM),
                      Paragraph(f"{si(b.get('school_dist_m',0))}/{si(b.get('hospital_dist_m',0))}/{si(b.get('hydro_dist_m',0))}",SM)])
    st=Table(rows_,colWidths=[1.5*cm,1.3*cm,1.7*cm,1.5*cm,1.9*cm,1.4*cm,1.4*cm,2.3*cm])
    s_sty=[("BACKGROUND",(0,0),(-1,0),CN),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
           ("FONTSIZE",(0,0),(-1,-1),7.5),("GRID",(0,0),(-1,-1),0.25,CG),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
           ("TOPPADDING",(0,0),(-1,-1),3),("BOTTOMPADDING",(0,0),(-1,-1),3),("LEFTPADDING",(0,0),(-1,-1),3),("VALIGN",(0,0),(-1,-1),"MIDDLE")]
    for idx,b in enumerate(proposed[:50],1):
        s_sty.append(("BACKGROUND",(0,idx),(0,idx),CLASS_BG.get(sp(b.get("class","C"),"C"),colors.white)))
    st.setStyle(TableStyle(s_sty)); story.append(st)
    story.append(Spacer(1,0.2*cm))
    story.append(Table([[Paragraph(f"■  {L('cls_a')}",ps("_la",fontSize=7.5,textColor=CGR)),
                          Paragraph(f"■  {L('cls_b')}",ps("_lb",fontSize=7.5,textColor=CAM)),
                          Paragraph(f"■  {L('cls_c')}",ps("_lc",fontSize=7.5,textColor=CB))]],
                        colWidths=[5.5*cm,5.5*cm,5.5*cm]))

    # ── S3 Scénarios ─────────────────────────────────────────────────────────
    story+=[Spacer(1,0.5*cm),Paragraph(L("s4"),H1)]
    SC_MAP={"balanced":L("sc_balanced"),"walk_first":L("sc_walk_first"),"access_first":L("sc_access_first")}
    rec_sc=sp(analysis.get("recommended_scenario","balanced"))
    sc_body=[["",L("sc_bins"),L("sc_cov"),L("sc_pk")]]
    for key,sc in (scenarios_d or {}).items():
        star="★  " if key==rec_sc else "   "
        sc_body.append([Paragraph(f"{star}<b>{SC_MAP.get(key,key)}</b>",SM),
                         Paragraph(str(si(sc.get("bin_count",0))),SM),
                         Paragraph(f"{ff(sc.get('coverage_pct',0),'.1f')} %",SM),
                         Paragraph(f"{ff(sc.get('avg_pickups',0),'.1f')}×",SM)])
    sct=Table(sc_body,colWidths=[6.5*cm,2.5*cm,2.5*cm,5*cm])
    sct.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,0),CB),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
                               ("FONTSIZE",(0,0),(-1,-1),8.5),("GRID",(0,0),(-1,-1),0.3,CG),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
                               ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),6),("ALIGN",(1,0),(-1,-1),"CENTER")]))
    story.append(sct)

    # ── S4 Lacunes ───────────────────────────────────────────────────────────
    story+=[Spacer(1,0.5*cm),Paragraph(L("s5"),H1)]
    gg=Table([
        [L("row_well"),f"{ff(gaps.get('well_served_pct',0),'.1f')} %",f"{si(gaps.get('well_served_pop',0)):,} {L('people')}"],
        [L("row_und"), f"{ff(gaps.get('underserved_pct',0),'.1f')} %",f"{si(gaps.get('underserved_pop',0)):,} {L('people')}"],
        [L("row_no"),  f"{ff(gaps.get('no_service_pct',0),'.1f')} %", f"{si(gaps.get('no_service_pop',0)):,} {L('people')}"],
        [L("row_wno"),"—",f"{ff(gaps.get('no_service_waste_kg_day',0),'.1f')} {L('kg_day')}"],
    ],colWidths=[6.5*cm,2.5*cm,7.5*cm])
    gg.setStyle(TableStyle([("ROWBACKGROUNDS",(0,0),(-1,-1),[colors.white,CI]),("GRID",(0,0),(-1,-1),0.3,CG),
                              ("BACKGROUND",(0,0),(0,-1),CP),("FONTSIZE",(0,0),(-1,-1),8.5),
                              ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),7)]))
    story.append(gg)
    top_cells=gaps.get("top_gap_cells",[]) or []
    if top_cells:
        c0=top_cells[0] or {}
        story+=[Spacer(1,0.1*cm),Paragraph(f"{L('top_ht')}: {sp(c0.get('grid_ref','?'))} — {ff(c0.get('waste_kg_day',0),'.1f')} {L('kg_day')} — {si(c0.get('population',0)):,} {L('people')}",FT)]

    # ── S5 Faisabilité ───────────────────────────────────────────────────────
    story+=[Spacer(1,0.5*cm),Paragraph(L("s6"),H1)]
    tsplit=readiness.get("transport_split",{}) or {}
    ft2=Table([
        [L("lbl_ready"),f"{read_score}/100 — {read_lbl}"],
        [L("class_a"),str(si(readiness.get("class_a",0)))],
        [L("class_b"),str(si(readiness.get("class_b",0)))],
        [L("class_c"),str(si(readiness.get("class_c",0)))],
    ...
    ft2.setStyle(TableStyle([("ROWBACKGROUNDS",(0,0),(-1,-1),[colors.white,CI]),("BACKGROUND",(0,0),(0,-1),CP),
                               ("GRID",(0,0),(-1,-1),0.3,CG),("FONTSIZE",(0,0),(-1,-1),8.5),
                               ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),7)]))
    story.append(ft2)
    if risks:
        story.append(Spacer(1,0.25*cm))
        rr=[[L("col_rsk"),L("col_mit")]]+[[Paragraph(sp(r.get("risk","")),SM),Paragraph(sp(r.get("mitigation","")),SM)] for r in risks]
        rt2=Table(rr,colWidths=[5*cm,11.5*cm])
        rt2.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,0),CB),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
                                   ("GRID",(0,0),(-1,-1),0.3,CG),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
                                   ("FONTSIZE",(0,0),(-1,-1),8.5),("TOPPADDING",(0,0),(-1,-1),4),("BOTTOMPADDING",(0,0),(-1,-1),4),("LEFTPADDING",(0,0),(-1,-1),5)]))
        story.append(rt2)

    # ── S6 Justification + Indicateurs ──────────────────────────────────────
    ...
    if conf_drv:
        ...
        cdt=Table([[L("drv_title"),L("drv_pct")]]+[[sp(d.get("label","")),f"{si(d.get('value',0))} %"] for d in conf_drv],colWidths=[12.5*cm,4*cm])
        cdt.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,0),CB),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
                                   ("GRID",(0,0),(-1,-1),0.3,CG),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
                                   ("FONTSIZE",(0,0),(-1,-1),8.5),("TOPPADDING",(0,0),(-1,-1),4),("BOTTOMPADDING",(0,0),(-1,-1),4),
                                   ("LEFTPADDING",(0,0),(-1,-1),6),("ALIGN",(1,0),(-1,-1),"CENTER")]))
        story.append(cdt)

    # ── S7 Notes méthodologiques ─────────────────────────────────────────────
    story+=[PageBreak(),Paragraph(L("s8"),H1),Paragraph(L("mb"),BD),Spacer(1,0.2*cm)]
    disc_t=Table([[Paragraph(L("disc"),ps("_di",fontSize=9,textColor=CN))]],colWidths=[16.5*cm])
    disc_t.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,-1),CP),("BOX",(0,0),(-1,-1),1,CS),
                                  ("LEFTPADDING",(0,0),(-1,-1),10),("TOPPADDING",(0,0),(-1,-1),9),("BOTTOMPADDING",(0,0),(-1,-1),9)]))
    story.append(disc_t)

    # ── S8 Point Check Manuel (conditionnel) ─────────────────────────────────
    if manual_res and (manual_res.get("points") or []):
        story+=[PageBreak(),Paragraph(L("s9"),H1)]
        bnr=Table([[Paragraph(L("m_banner"),ps("_mb",fontSize=9,fontName="Helvetica-Bold",textColor=colors.HexColor("#92400e")))]],colWidths=[16.5*cm])
        bnr.setStyle(TableStyle([("BACKGROUND",(0,0),(-1,-1),colors.HexColor("#FFF8E6")),("BOX",(0,0),(-1,-1),1,colors.HexColor("#D97706")),
        ...
        ct=Table([
            ...
            [L("m_waste"),f"{ff(coll.get('total_waste_r1',0),'.1f')} {L('kg_day')}"],
            [L("m_cov"),f"{ff(coll.get('coverage_pct',0),'.1f')} %"],
        ...
        ct.setStyle(TableStyle([("ROWBACKGROUNDS",(0,0),(-1,-1),[colors.white,CI]),("BACKGROUND",(0,0),(0,-1),CP),
                                  ("GRID",(0,0),(-1,-1),0.3,CG),("FONTSIZE",(0,0),(-1,-1),8.5),
                                  ("TOPPADDING",(0,0),(-1,-1),5),("BOTTOMPADDING",(0,0),(-1,-1),5),("LEFTPADDING",(0,0),(-1,-1),7)]))
        story.append(ct)
        story+=[Spacer(1,0.25*cm),Paragraph(L("m_s2"),H2)]
        VIB_BG={"high":colors.HexColor("#D1FAE5"),"medium":colors.HexColor("#FEF3C7"),"low":colors.HexColor("#FEE2E2")}
        VIB_LBL={"high":L("vib_h"),"medium":L("vib_m"),"low":L("vib_l")}
        pt_rows=[["ID",L("col_sc"),L("col_md"),"Viab.",L("col_pp"),L("col_wt"),L("col_fq")]]
        for pt in (manual_res.get("points",[]) or []):
            vib=sp(pt.get("viability","medium"),"medium"); mode=MODE_LBL.get(sp(pt.get("collection_mode","—"),"—"),sp(pt.get("collection_mode","—")))
            pt_rows.append([Paragraph(f"<b>{sp(pt.get('id','?'))}</b>",SM),Paragraph(ff(pt.get("score",0),".3f"),SM),Paragraph(mode,SM),
                             Paragraph(VIB_LBL.get(vib,vib),SM),Paragraph(f"{si(pt.get('population_r1',0)):,}",SM),
                             Paragraph(ff(pt.get("waste_r1_kg_day",0),".1f"),SM),Paragraph(f"{sp(pt.get('pickups_per_week','—'))}×",SM)])
        ptt=Table(pt_rows,colWidths=[1.5*cm,1.5*cm,1.9*cm,1.6*cm,1.5*cm,2.1*cm,1.5*cm])
        ps_=[("BACKGROUND",(0,0),(-1,0),CN),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),
              ("FONTSIZE",(0,0),(-1,-1),7.5),("GRID",(0,0),(-1,-1),0.25,CG),("ROWBACKGROUNDS",(0,1),(-1,-1),[colors.white,CI]),
              ("TOPPADDING",(0,0),(-1,-1),3),("BOTTOMPADDING",(0,0),(-1,-1),3),("LEFTPADDING",(0,0),(-1,-1),3)]
        for i_,pt in enumerate(manual_res.get("points",[]) or [],1):
            ps_.append(("BACKGROUND",(3,i_),(3,i_),VIB_BG.get(sp(pt.get("viability","medium"),"medium"),colors.white)))
        ptt.setStyle(TableStyle(ps_)); story.append(ptt)
        story+=[Spacer(1,0.25*cm),Paragraph(L("m_note"),ps("_mn",fontSize=8.5,textColor=colors.HexColor("#5A6E84"),leading=12,alignment=TA_JUSTIFY))]

    # Pied de page
    story+=[Spacer(1,0.6*cm),HRFlowable(width="100%",thickness=1,color=CG),Spacer(1,0.1*cm),Paragraph(L("footer"),FT)]

    try:
        doc.build(story)
    except Exception as exc:
        raise HTTPException(status_code=500,detail=f"PDF build error: {str(exc)}")

    buf.seek(0)
    tag="FR" if lang=="fr" else "EN"
    slug="".join(c if c.isalnum() or c in "-_" else "_" for c in city)[:30]
    return StreamingResponse(buf,media_type="application/pdf",
        headers={"Content-Disposition":f'attachment; filename="UrbanSanity_{slug}_{tag}.pdf"'})
